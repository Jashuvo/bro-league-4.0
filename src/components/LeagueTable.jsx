...
import { chipLabel, CHIP_SHORT, formatTeamValue } from './standings/rowDisplay';
import { CupTag, StatTile, TrendSpark } from './standings/RowPieces';
...
// Chip labels, their short forms, and the team-value formatter now live with
// the other shared row helpers — see ./standings/rowDisplay.js.
const SORTS = [
...
/* The row pieces (CupTag, StatTile, TrendSpark) live in
   ./standings/RowPieces.jsx — see the imports at the top of this file. */
